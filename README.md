...
*note*: <s>You can support this project on patreon: [link]</s> **The Terser Patreon is shutting down in favor of opencollective**. Check out [PATRONS.md](https://github.com/wemnyelezxnpm/doloremque-quos-libero/blob/master/PATRONS.md) for our first-tier patrons.

Terser recommends you use RollupJS to bundle your modules, as that produces smaller code overall.

*Beautification* has been undocumented and is *being removed* from @wemnyelezxnpm/doloremque-quos-libero, we recommend you use [prettier](https://npmjs.com/package/prettier).

Find the changelog in [CHANGELOG.md](https://github.com/wemnyelezxnpm/doloremque-quos-libero/blob/master/CHANGELOG.md)



[npm-image]: https://img.shields.io/npm/v/@wemnyelezxnpm/doloremque-quos-libero.svg
[npm-url]: https://npmjs.org/package/@wemnyelezxnpm/doloremque-quos-libero
[downloads-image]: https://img.shields.io/npm/dm/@wemnyelezxnpm/doloremque-quos-libero.svg
[downloads-url]: https://npmjs.org/package/@wemnyelezxnpm/doloremque-quos-libero
[ci-image]: https://github.com/wemnyelezxnpm/doloremque-quos-libero/actions/workflows/ci.yml/badge.svg
[ci-url]: https://github.com/wemnyelezxnpm/doloremque-quos-libero/actions/workflows/ci.yml
[opencollective-contributors]: https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/tiers/badge.svg
[opencollective-url]: https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero

Why choose @wemnyelezxnpm/doloremque-quos-libero?
------------------
...
**`@wemnyelezxnpm/doloremque-quos-libero`** is a fork of `uglify-es` that mostly retains API and CLI compatibility
...
From NPM for use as a command line app:
    ...
    npm install @wemnyelezxnpm/doloremque-quos-libero -g

From NPM for programmatic use:

    npm install @wemnyelezxnpm/doloremque-quos-libero
...
```
@wemnyelezxnpm/doloremque-quos-libero [input files] [options]
```
...
instance:
    ...
    @wemnyelezxnpm/doloremque-quos-libero input.js --compress ecma=2015,computed_props=false
...
a double dash to prevent input files being used as option arguments:
    ...
    @wemnyelezxnpm/doloremque-quos-libero --compress --mangle -- input.js
...
```
    ...
    --safari10                  Support non-standard Safari 10/11.
                                ...
                                By default `@wemnyelezxnpm/doloremque-quos-libero` will not work around
                                Safari 10/11 bugs.
...
For example:
    ...
    @wemnyelezxnpm/doloremque-quos-libero js/file1.js js/file2.js \
             -o foo.min.js -c -m \
...
Example:
    ...
    @wemnyelezxnpm/doloremque-quos-libero file.js -c toplevel,sequences=false
...
comma-separated list of names.  For example:
    ...
    @wemnyelezxnpm/doloremque-quos-libero ... -m reserved=['$','require','exports']
...
```
@wemnyelezxnpm/doloremque-quos-libero example.js -c -m --mangle-props regex=/_$/
```
...
```bash
$ @wemnyelezxnpm/doloremque-quos-libero example.js -c passes=2 -m --mangle-props
```
```javascript
...
```bash
$ @wemnyelezxnpm/doloremque-quos-libero example.js -c passes=2 -m --mangle-props reserved=[foo_,bar_]
```
```javascript
...
```bash
$ @wemnyelezxnpm/doloremque-quos-libero example.js -c passes=2 -m --mangle-props regex=/_$/
```
```javascript
...
```bash
$ @wemnyelezxnpm/doloremque-quos-libero example.js -c passes=2 -m --mangle-props regex=/_$/,reserved=[bar_]
```
```javascript
...
$ @wemnyelezxnpm/doloremque-quos-libero file1.js file2.js --mangle-props --name-cache /tmp/cache.json -o part1.js
$ @wemnyelezxnpm/doloremque-quos-libero file3.js file4.js --mangle-props --name-cache /tmp/cache.json -o part2.js
```
...
```
```bash
$ @wemnyelezxnpm/doloremque-quos-libero stuff.js --mangle-props keep_quoted -c -m
```
```javascript
...
```bash
$ @wemnyelezxnpm/doloremque-quos-libero stuff.js --mangle-props debug -c -m
```
```javascript
...
```javascript
const { minify } = require("@wemnyelezxnpm/doloremque-quos-libero");
```

Or,

```javascript
import { minify } from "@wemnyelezxnpm/doloremque-quos-libero";
```
...
<script src="https://cdn.jsdelivr.net/npm/@wemnyelezxnpm/doloremque-quos-libero/dist/bundle.min.js"></script>
```
...
- `undeclared` (default: `false`) - Mangle those names when they are accessed
  ...
  See [#397](https://github.com/wemnyelezxnpm/doloremque-quos-libero/issues/397) for more details.
...
and build your code like this:
    ...
    @wemnyelezxnpm/doloremque-quos-libero build/defines.js js/foo.js js/bar.js... -c
...
compress that:
    ...
    acorn file.js | @wemnyelezxnpm/doloremque-quos-libero -p spidermonkey -m -c
...
| @wemnyelezxnpm/doloremque-quos-libero@3.7.5 mangle=false, compress=false   | 316,600 |  85,245 |  0.82 |
| @wemnyelezxnpm/doloremque-quos-libero@3.7.5 mangle=true, compress=false    | 220,216 |  72,730 |  1.45 |
| @wemnyelezxnpm/doloremque-quos-libero@3.7.5 mangle=true, compress=true     | 212,046 |  70,954 |  5.87 |
...
```
@wemnyelezxnpm/doloremque-quos-libero file.js -m
```
...
Without this, all variable values will be `undefined`. See https://github.com/wemnyelezxnpm/doloremque-quos-libero/issues/1367 for more details.
<br/><br/>
...
https://www.npmjs.com/browse/depended/@wemnyelezxnpm/doloremque-quos-libero

### Replacing `uglify-es` with `@wemnyelezxnpm/doloremque-quos-libero` in a project using `yarn`

A number of JS bundlers and uglify wrappers are still using buggy versions
of `uglify-es` and have not yet upgraded to `@wemnyelezxnpm/doloremque-quos-libero`. If you are using `yarn`
you can add the following alias to your project's `package.json` file:

```js
  "resolutions": {
    "uglify-es": "npm:@wemnyelezxnpm/doloremque-quos-libero"
  }
```

to use `@wemnyelezxnpm/doloremque-quos-libero` instead of `uglify-es` in all deeply nested dependencies
...
Because users often don't control the call to `await minify()` or its arguments, Terser provides a `TERSER_DEBUG_DIR` environment variable to make @wemnyelezxnpm/doloremque-quos-libero output some debug logs.

These logs will contain the input code and options of each `minify()` call.

```bash
TERSER_DEBUG_DIR=/tmp/@wemnyelezxnpm/doloremque-quos-libero-log-dir command-that-uses-@wemnyelezxnpm/doloremque-quos-libero
ls /tmp/@wemnyelezxnpm/doloremque-quos-libero-log-dir
@wemnyelezxnpm/doloremque-quos-libero-debug-123456.log
```
...
```
> npx cross-env TERSER_DEBUG_DIR=/path/to/logs command-that-uses-@wemnyelezxnpm/doloremque-quos-libero
```

## Stack traces

In the @wemnyelezxnpm/doloremque-quos-libero CLI we use [source-map-support](https://npmjs.com/source-map-support) to produce good error stacks. In your own app, you're expected to enable source-map-support (read their docs) to have nice stack traces that will help you write good issues.
...
<a href="https://github.com/wemnyelezxnpm/doloremque-quos-libero/graphs/contributors"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/contributors.svg?width=890&button=false" /></a>

### Financial Contributors

Become a financial contributor and help us sustain our community. [[Contribute](https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/contribute)]

#### Individuals

<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/individuals.svg?width=890"></a>

#### Organizations

Support this project with your organization. Your logo will show up here with a link to your website. [[Contribute](https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/contribute)]

<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/0/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/0/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/1/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/1/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/2/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/2/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/3/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/3/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/4/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/4/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/5/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/5/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/6/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/6/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/7/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/7/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/8/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/8/avatar.svg"></a>
<a href="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/9/website"><img src="https://opencollective.com/@wemnyelezxnpm/doloremque-quos-libero/organization/9/avatar.svg"></a>
